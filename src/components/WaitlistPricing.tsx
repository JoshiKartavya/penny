        ...
        <div className="bg-white rounded-[2rem] p-8 border-2 border-black/90 shadow-xl flex flex-col relative overflow-hidden">
          ...
          <div className="mt-auto">
            {!isSubmitted ? (
              ...
              <div className="bg-[#23c55e]/10 border border-[#23c55e]/20 rounded-2xl p-6 mb-4 flex flex-col items-center justify-center text-center">
                <div className="w-12 h-12 bg-[#23c55e] text-white rounded-full flex items-center justify-center mb-3">
            ...
            <div className="flex items-center justify-center space-x-1.5 text-xs text-gray-400 font-medium mt-4">
